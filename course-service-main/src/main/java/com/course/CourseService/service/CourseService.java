...
//    //search
//    public List<String> searchCourseNames(String prefix) {
//        List<Course> course = courseRepository.findAllByPrefix(prefix);
//        return course.stream().map(Course::getTitle).collect(Collectors.toList());
//    }
	...
	public String getdetails(String title) {
		Optional<Course> c=courseRepository.findByTitle(title);
		return c.get().getDescription();
